...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://shagha-sh:shagha@cluster0.zygvozb.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
